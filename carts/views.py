...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        # get selected variations (color, size)
        ...
        if is_cart_item_exists:
            ...
            if product_variation in ex_var_list:
                ...
                # create a new cart item if variation is different
            ...
            # create new cart item if none exist
        ...
        if is_cart_item_exists:
            cart_items = CartItem.objects.filter(product=product, cart=cart)  # get all matching items
            ex_var_list = []
            id_list = []
